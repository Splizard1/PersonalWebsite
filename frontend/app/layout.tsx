...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-screen flex flex-col text-slate-800 dark:text-slate-100 transition-colors">
        <ThemeProvider>
          <Nav />
          <main className="flex-1"><ViewTransition>{children}</ViewTransition></main>
